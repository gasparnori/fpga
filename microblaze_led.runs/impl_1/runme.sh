...
HD_PWD='D:/Nora/cmod_a7_projects/microblaze_led/microblaze_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_wrapper.tcl -notrace
