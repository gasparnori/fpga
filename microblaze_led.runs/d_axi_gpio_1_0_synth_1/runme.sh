...
HD_PWD='D:/Nora/cmod_a7_projects/microblaze_led/microblaze_led.runs/d_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_axi_gpio_1_0.tcl
